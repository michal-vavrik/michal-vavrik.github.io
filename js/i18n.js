...
window.I18n = (function () {
	...
	var translations = {
		cs: {
			...
			'nv194.mode.chapters.hint': 'Otázky z jedné nebo více vybraných kapitol v pořadí',
		...
		en: {
			...
			'nv194.mode.chapters.hint': 'Questions from one or more selected chapters in order',
